	...
	<div class="limiter">
        ...
        <div class="login-left">
  				<div class="login100-pic js-tilt" data-tilt>
  					<img src="<?php echo base_url('assets/dist/img/logo.png'); ?>" alt="IMG">
  				</div>
      </div>

        <div class="login-right">
            <?php echo form_open('auth',array('class' => 'login100-form validate-form')); ?>
				<!-- <form class="login100-form validate-form" id="login_form" method="post" action="<?php //echo base_url('auth'); ?>"> -->

          <span class="login100-form-title1">
            <img src="<?php echo base_url('assets/dist/img/logo.png'); ?>"
            class="logo-login" alt="New Jiandra Logo">
          </span>
