      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <button class="users button1 float-sm-right" data-toggle="modal" data-target="#AddPurchaseOrder"><i
              class="fas fa-plus-circle" aria-hidden="true"></i> Purchase Order </button>
>>>>>>> 92766d89743b3b751ae97ffebb7c32ec49d0e62d

          <!--Add User Modal -->
          <!-- Modal -->
          <div class="modal fade" id="AddPurchaseOrder" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
                      ...
                      <div class="col-6">
                        <div class="form-group">
                          ...
                          <select class="form-control" class="company" name="company">
                            ...
                            <option value="<?php echo $value['company_id'] ?>"><?php echo $value['company_name'] ?>
                            </option>
                            <?php  endforeach; ?>
                          </select>
                          <span class="err"></span>
...
=======
                          <tr>
                            ...
                            <td class="purch_td">
                              <input type="text" class="form-control purchase_quantity number_only" name="quantity[]"
                                value="">
                              <span class="err"></span>
                            </td>
                            <td class="purch_td">
                              <input type="text" class="form-control purchase_price number_only" name="unit_price[]"
                                value="">
                              <span class="err"></span>
                            </td>
                            <td class="purch_td">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12 col-lg-6 order-md-2">
                        <div class="form-horizontal">
                          <div class="form-group row m-b-10">
                            <label for="batchCode" class="col-md-12 col-lg-4 col-form-label">Quantity <span
                                class="text-red">*</span></label>
                            <div class="col-lg-8 col-md-12">
                              <input type="text" class="form-control disabled-normal total_quantity"
                                name="total_quantity" readonly="" disabled="">
>>>>>>> 92766d89743b3b751ae97ffebb7c32ec49d0e62d
                            </div>
                          </div>
                          ...
                          <div class="form-group row m-b-10">
                            ...
                            <div class="col-lg-8 col-md-12">
                              <div class="input-group m-b-0">
                                ...
                                <input type="text" class="form-control disabled-normal total_cost" name="total_cost"
                                  readonly="" disabled="">
                              </div>
                            </div>
<<<<<<< HEAD
...
=======
                        ...
                        <div class="form-horizontal">
                          <div class="form-group row m-b-10">
                            <label for="batchCode" class="col-md-12 col-lg-4 col-form-label">Grand Total <span
                                class="text-red">*</span></label>
                            <div class="col-lg-8 col-md-12">
                              <div class="input-group m-b-0">
                                <div class="input-group-prepend">
...
>>>>>>> 92766d89743b3b751ae97ffebb7c32ec49d0e62d
                                ...
                                <input type="text" class="form-control disabled-normal grand_total" name="grand_total"
                                  readonly="" disabled="">
                              </div>
                            </div>
                          </div>
        ...
        <!--View User Modal -->
        <!-- Modal -->
        <div class="modal fade" id="ViewPurchaseOrders" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
          aria-hidden="true">
          ...
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              ...
              <div class="table-responsive purch_prod">
                <table class="table table-bordered table-striped purchase" role="grid" aria-describedby="example1_info"
                  id="view_purchase_orders_details">
                  <thead>
                    <th class="header-title purch">SKU</th>
                    <th class="header-title purch">Product</th>
                    <th class="header-title purch">Quantity </th>
              ...
              <div class="row summary">
                ...
                <div class="col-md-12 col-lg-6 order-md-2">
                  <div class="form-horizontal">
                    <div class="form-group row m-b-10">
                      <label for="batchCode" class="col-md-12 col-lg-4 col-form-label">Quantity</label>
                      <div class="col-lg-8 col-md-12">
        ...
        <!--View Edit Modal -->
        <!-- Modal -->
        <div class="modal fade" id="EditPurchaseOrder" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
          aria-hidden="true">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body" id="addProduct">
                  ...
                  <div class="row">
                    <div class="col-6">
                      <label for="note">Note: </label>
                      <textarea rows="4" cols="50" class="form-control note" name="purchase_note" value=""></textarea>
                    </div>
                    <div class="col-md-12 col-lg-6 order-md-2">
                      <div class="form-horizontal">
                        <div class="form-group row m-b-10">
                          <label for="batchCode" class="col-md-12 col-lg-4 col-form-label">Quantity <span
                              class="text-red">*</span></label>
                          <div class="col-lg-8 col-md-12">
                            <input type="text" class="form-control disabled-normal total_quantity" readonly=""
                              disabled="">
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="form-group row m-b-10">
                          ...
                          <div class="col-lg-8 col-md-12">
                            <div class="input-group m-b-0">
                              ...
                              <input type="text" class="form-control disabled-normal total_cost" readonly=""
                                disabled="">
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="form-group row m-b-10">
                          ...
                          <div class="col-lg-8 col-md-12">
                            <div class="input-group m-b-0">
                              ...
                              <input type="text" class="form-control disabled-normal grand_total" readonly=""
                                disabled="">
                            </div>
                          </div>
                        </div>
                ...
                <div class="row deliver">
                  <div class="col-12">
                    <div class="form-group">
                      ...
                      <select class="form-control" class="delivery_status" name="delivery_status" id="delivery_status"
                        value="">
